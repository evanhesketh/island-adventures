...
export default function Calendar({
  ...
  return (
    <>
    {userRole === "user" && <CalendarPublic datesBooked={datesBooked} date={date} monthGrid={monthGrid}/>}
    {(userRole === "admin" || userRole === "staff") && <CalendarPrivate datesBooked={datesBooked} date={date} monthGrid={monthGrid} />}
  </>
  );
}